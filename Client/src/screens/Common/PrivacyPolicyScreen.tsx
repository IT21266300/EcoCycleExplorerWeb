    ...
    return (
        <SafeAreaView style={[ScreenStyles.container]}>
            ...
            <ScrollView contentContainerStyle={[ScreenStyles.subContainer]}>
                ...
                <Text style={styles.PolicyText}>By using TaskBear's service, you agree to be bound by these terms and
                ...
                <Text style={styles.PolicyText}>TaskBear provides a platform to connect users with skilled handymen
                    for
                ...
                <Text style={styles.PolicyText}>These terms and conditions are governed by the laws of
                    ...
                    courts.</Text>
                <Text style={styles.PolicyText}> By using TaskBear's handyman service, you acknowledge that you have
                    read,
                ...
                <Text style={styles.PolicyText}>TaskBear reserves the right to modify these terms and conditions at
                    any time.
